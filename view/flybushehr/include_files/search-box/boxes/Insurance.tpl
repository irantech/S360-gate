...
<select aria-hidden="true" class="select2_in select2-hidden-accessible insurance-destination-country-js select2" data-placeholder="نام کشور مقصد" id="insurance_destination_country" name="insurance_destination_country" tabindex="-1">
...
<div class="col-lg-2 col-md-12 col-sm-12 col-12 col_search search_btn_insuranc">
