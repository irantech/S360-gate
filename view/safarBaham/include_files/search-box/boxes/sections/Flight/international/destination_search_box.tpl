...
<input autocomplete="off" class="inputSearchForeign iata-destination-international-js input-search-box" id="iata_destination_international" name="iata_destination_international" onclick='displayCityListExternal("destination" , event)' placeholder="مقصد ( شهر )" type="text"/>
