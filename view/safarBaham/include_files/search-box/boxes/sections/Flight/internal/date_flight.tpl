...
<div class="caption-input-search-box">تاریخ پرواز برگشت را انتخاب کنید</div>
<input class="checktest returnCalendar return_input internal-arrival-date-js" disabled="" id="arrival_date_internal" name="arrival_date_internal" placeholder="تاریخ برگشت" readonly="" type="text"/>
</div>
</div>