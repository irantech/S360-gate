...
<div class="caption-input-search-box">تاریخ ورود خود را انتخاب کنید</div>
<input autocomplete="off" class="init-shamsi-datepicker check-in-date-js" data-type="internal" id="startDateForHotelLocal" name="startDateForHotelLocal" placeholder="تاریخ ورود" type="text"/>
</div>
</div>