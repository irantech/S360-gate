...
<div class="caption-input-search-box">
 شهر مقصد خود را وارد کنید
</div>
<select aria-hidden="true" class="select2_in select2-hidden-accessible entertainment-city-js" data-placeholder="مقصد ( شهر )" id="select_entertainment_city" name="select_entertainment_city" onchange="getEntertainmentCategoriesSearchBox($(this))" tabindex="-1">
