...
<input autocomplete="off" class="inputSearchForeign w-100" id="autoComplateSearchIN" name="autoComplateSearchIN" onclick="openBoxPopular('hotel')" onkeyup="searchCity('hotel')" placeholder="مقصد یا هتل (داخلی)" type="text" value=""/>
