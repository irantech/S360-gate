...
<div class="caption-input-search-box">تاریخ خروج خود را انتخاب کنید</div>
<input autocomplete="off" class="init-shamsi-return-datepicker check-out-date-internal-js" data-type="internal" id="endDateForHotelLocal" name="endDateForHotelLocal" placeholder="تاریخ خروج" type="text"/>
</div>
</div>