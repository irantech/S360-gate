<div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search date_search p-1">
    <div class="parent-input-search-box">
        ...
        <label for='departure_date_package' class="caption-input-search-box">تاریخ رفت را انتخاب کنید</label>
        <input readonly="" type="text"
               class="packageDeptCalender  went  departure-date-package-js" name="departure_date_package" id="departure_date_package" placeholder="تاریخ رفت">
    </div>
</div>
<div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search date_search p-1">
    <div class="parent-input-search-box">
        ...
        <div class="caption-input-search-box">تاریخ برگشت را انتخاب کنید</div>
        <input readonly="" type="text" name="arrival_date_package" id="arrival_date_package" class=" return_input2  packageReturnCalender package-arrival-date-js" placeholder="تاریخ برگشت">
    </div>
</div>