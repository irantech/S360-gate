...
{load_presentation_object filename="safiran" assign="obj_main_page" subName="customers"}
...
<meta name="google-site-verification" content="p9Rv1ZN-3gVB0PjvAlcFtTXh0_aYt95n2UwVcdRT5fs" />
...
<link href="project_files/images/favicon.png" rel="shortcut icon" type="image/x-icon"/>
    ...
    <script type="text/javascript">
      window.RAYCHAT_TOKEN = "06373f34-15f6-400b-9940-26d98b4e9e3f";
      (function () {
        d = document;
