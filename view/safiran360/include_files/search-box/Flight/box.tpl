...
<div class="__box__ tab-pane active" id="Flight">
    {if $page['slug'] neq 'flight-foreign' && $page['slug'] neq 'flight-iran'}
    <div class="radios">
        <div class="switch">
    ...
    <div {if $page['slug'] eq 'flight-foreign'} style='display: none' {/if} class="d_flex flex-wrap internal-flight-js" id="internal_flight">
        <form class="d_contents" id="internal_flight_form" method="post" name="internal_flight_form" target="_blank">
            <div class="col-md-12 col-xs-12 col-sm-12 d-ceckboxs">
                <div class="{if $page['slug'] neq 'flight-foreign' && $page['slug'] neq 'flight-iran'}cntr{else}mb-3{/if}">
...
<input autocomplete="off" class="inputSearchForeign form-control route_destination_internal-js" id="route_destination_internal" name="route_destination_internal" onclick="displayCityList('destination')" placeholder="مقصد ( شهر )" type="text"/>
    ...
    <div {if $page['slug'] eq 'flight-foreign'} style='display: flex' {/if}  class="flex-wrap international-flight-js" id="international_flight">
