                        ...
                        <ul class="nav-menu align-to-right">
                            <li>
                                ...
                                <ul class="nav-dropdown nav-submenu">
                                    <li>
                                        <a href="{$smarty.const.ROOT_ADDRESS}/page/flight-iran">پرواز داخلی</a>
                                    </li>
                                    <li>
                                        <a href="{$smarty.const.ROOT_ADDRESS}/page/flight-foreign">پرواز خارجی</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-dropdown nav-submenu">
                                    <li>
                                        <a href="{$smarty.const.ROOT_ADDRESS}/page/hotel-iran">داخلی</a>
                                    </li>
                                    <li>
                                        <a href="{$smarty.const.ROOT_ADDRESS}/page/hotel-foreign">خارجی</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
...
{*                                    </li>*}
{*                                    <li>*}
{*                                        <a href="https://soroshparvaz.com/gds/fa/mag/Installment-tour">تور اقساطی</a>*}
{*                                    </li>*}
{*                                </ul>*}
                            </li>
                            <li>
                                <a class="installment-tour" href="https://soroshparvaz.com/gds/fa/mag/Installment-tour">تور اقساطی</a>
                            </li>
                            <li>
                ...
                <div class="parent-btn-header">
                    ...
                    <a class="button btn-user {if $obj_main_page->isLogin()}show-box-login-js main-navigation__button2{else}main-navigation__button1{/if}" href="{if $obj_main_page->isLogin()}javascript:{else}{$smarty.const.ROOT_ADDRESS}/authenticate{/if}">
