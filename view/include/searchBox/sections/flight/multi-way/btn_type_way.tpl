<div class="col-md-12 col-xs-12 col-sm-12 d-ceckboxs">
    <div class="cntr">
        ...
        <label for="rdo-4" class="btn-radio select_multiway mr-4 click_flight_twoWay">
        ...
        {if $smarty.const.SOFTWARE_LANG eq 'fa'}
            <label for="rdo-5" class="btn-radio mr-4 select_multiway click_flight_multiTrack">
