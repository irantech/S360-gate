<div class="__box__ tab-pane shadow-box {if  $smarty.const.GDS_SWITCH eq 'page'}active{/if}" id="Hotel_internal" style="padding:2.5px !important">
{*    {include file="./sections/Hotel/international/btn_radio_internal_external.tpl"}*}
    <div class="d_flex flex-wrap align-items-center internal-hotel-js" id="internal_hotel">
        <form class="d_contents" data-action="s360online.iran-tech.com/" id="internal_hotel_form" method="post" name="gdsHotelLocal" target="_blank">
            ...
            <div class="col-xl-1 col-lg-6 col-md-6 col-sm-6 col-12 mt-14-px btn_s col_search d-flex mr-auto m-sm-auto">
                <button class="btn theme-btn seub-btn b-0 mb-xl-0  mb-sm-2" style="left:8px" onclick="searchInternalHotel()" type="button"><span>جستجو</span></button>
            </div>
        </form>
    </div>
</div>
<div class="__box__ tab-pane shadow-box {if  $smarty.const.GDS_SWITCH eq 'page'}active{/if}" id="Hotel_external" style="padding:2.5px !important">

    <div class="flex-wrap international-hotel-js d-flex align-items-center" id="international_hotel">
        <form class="d_contents" data-action="https://s360online.iran-tech.com/" id="international_hotel_form" method="post" target="_blank">
            ...
            <div class="col-xl-1 col-lg-6 col-md-6 col-sm-6 col-12 btn_s col_search d-flex mr-auto m-sm-auto mt-14-px">
                ...
                <button class="btn theme-btn seub-btn b-0 mb-xl-0 mb-sm-2" style="left:8px" onclick="searchInternationalHotel()" type="button"><span>جستجو</span></button>
            </div>
        </form>
    </div>
