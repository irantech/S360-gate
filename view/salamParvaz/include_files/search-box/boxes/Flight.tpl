<div class="__box__ tab-pane shadow-box active" id="Flight_internal" >
    <div id="internal_flight" class="_internal align-items-center d_flex flex-wrap internal-flight-js">
...
<div class="__box__ tab-pane shadow-box" id="Flight_external">
    <div id="international_flight" class="_external align-items-center flex-wrap international-flight-js">
