...
<input autocomplete="off" class="inputSearchLocal route_origin_internal-js input-search-box" id="route_origin_internal" name="route_origin_internal" onclick="displayCityList('origin')" placeholder="مبدأ ( شهر )" type="text"/>
