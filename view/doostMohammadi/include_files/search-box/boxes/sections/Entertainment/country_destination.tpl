...
<div class="caption-input-search-box">
 کشور مقصد خود را وارد کنید
</div>
<select aria-hidden="true" class="select2_in entertainment-destination-country-js select2-hidden-accessible" data-placeholder="مقصد ( کشور )" id="select_entertainment_country" name="select_entertainment_country" onchange="getEntertainmentCities($(this))" tabindex="-1">
