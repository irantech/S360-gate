...
<div class="float-sm">
 <div class="__telegram_class__ fl-fl float-gp">
  ...
  <a class="SMTelegram" href="{if $telegramHref}{$telegramHref}{/if}" target="_blank">به ما ملحق شو!</a>
 </div>
 <div class="__whatsapp_class__ fl-fl float-rs">
  <i class="fab fa-whatsapp"></i>
  <a class="SMWhatsApp" href="{if $whatsappHref}{$whatsappHref}{/if}" target="_blank">تماس با ما!</a>
 </div>
 <div class="__instagram_class__ fl-fl float-ig">
  <i class="fab fa-instagram"></i>
  <a class="SMInstageram" href="{if $instagramHref}{$instagramHref}{/if}" target="_blank">ما رو دنبال کن!</a>
 </div>
</div>