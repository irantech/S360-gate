...
{if $check_general}
    <div class="i_modular_tours section_special_tour">
        <div class="container">
            ...
            <div class="__tour__special__ popular_places_area">
                <div class="row">
                            ...
                            {if $min_ <= $max_}
                                <div class="__i_modular_nc_item_class_0 item">
                                    <div class="single_place">
                                               ...
                                               href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id']}/{$item['tour_slug']}">
                                                <div class="package__details__inner">
                                                    ...
                                                    <p class="packg__prize">
                                                        <span class="___price_class__">{$item['min_price']['discountedMinPriceR']|number_format}</span>تومان
                                                    </p>
                                                </div>
                                            </a>
                                        </div>
                                        ...
                                        <span><i class="fa fa-clock"></i> مدت تور : <em class="__night_class__">{$item['night']}</em>شب
                                        </span>
                                          <span>
