...
<input autocomplete="off" class="form-control inputSearchLocal route_origin_internal-js" id="route_origin_internal" name="route_origin_internal" onclick="displayCityList('origin')" placeholder="##Selectsource##" type="text"/>
<input class="origin-internal-js" data-border-red="#route_origin_internal" id="route_origin_internal" name="route_origin_internal" placeholder="##Origin##" type="hidden" value=""/>
