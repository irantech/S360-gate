...
<input autocomplete="off" class="form-control inputSearchForeign iata-origin-international-js" id="iata_origin_international" name="iata_origin_international" onclick='displayCityListExternal("origin" , event)' placeholder="##OriginCityAirPlane2##" type="text"/>
