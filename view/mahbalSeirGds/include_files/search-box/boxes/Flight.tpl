...
<button class="btn theme-btn seub-btn b-0" onclick="searchFlight('internal')" type="button"><span>##Search##</span></button>
</div>
</form>
</div>
...
<div class="col-lg-2 col-md-3 col-sm-6 col-12 btn_s col_search margin-center">
<button class="btn theme-btn seub-btn b-0" onclick="searchFlight('international')" type="button"><span>##Search##</span></button>
</div>
</form>
</div>
