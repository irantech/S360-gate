...
{load_presentation_object filename="mahbalSeirGdsEn" assign="obj_main_page" subName="customers"}
...
<link href="project_files/css/{$StyleSheetHeader}" rel="stylesheet"/>
    ...
    {if $smarty.const.GDS_SWITCH eq 'mainPage' || $smarty.const.GDS_SWITCH eq 'page'}
        <link rel="stylesheet" href="project_files/css/tabs2.css">
    {else}
    ...
    {if $smarty.const.GDS_SWITCH eq 'mainPage' || $smarty.const.GDS_SWITCH eq 'page'}
        <link rel="stylesheet" href="project_files/css/style2.css">
        {else}
        <link rel="stylesheet" href="project_files/css/style.css">
    {/if}
    <style>
        .ui-datepicker , .cbox-count-passenger, .hotel_passenger_picker, .box-of-count-passenger-boxes {
