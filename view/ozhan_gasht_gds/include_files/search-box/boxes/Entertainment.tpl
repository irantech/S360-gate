<div class="tab-pane {if  $smarty.const.GDS_SWITCH eq 'page'} active {/if}" id="Entertainment">
    <div class="col-md-12 col-12">
        <div class="row">
            <form data-action="https://s360online.iran-tech.com/" target="_blank" class="d_contents" method="post"
                ...
                <div class="col-lg-2 col-md-2 col-sm-6 col-12 btn_s col_search margin-center">
                    <button type="button" onclick="searchEntertainment()"
                            class="btn theme-btn seub-btn b-0"><span>
