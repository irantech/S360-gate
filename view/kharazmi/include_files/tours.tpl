...
{assign var="tour_params_external" value=['type'=>'','limit'=> '3','dateNow' => $dateNow, 'country' =>'external','city' => null]}
...
<h2>تورهای محبوب داخلی و خارجی </h2>
<p>سفرهای ویژه با تجربیات بی‌نظیر در دنیای گردشگری با تورهای جذاب داخلی و خارجی</p>
</div>
</div>
<div>
...
<a class="__i_modular_nc_item_class_0 link-parent" href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id']}/{$item['tour_slug']}">
<div class="parent-img-tour">
<img alt="{$item['tour_name']}" class="__image_class__" src="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/pic/reservationTour/{$item['tour_pic']}"/>
<div class="night">
<i class="fa-light fa-clock"></i>
