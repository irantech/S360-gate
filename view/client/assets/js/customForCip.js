            ...
            <div class="cip-passenger-body">
                ...
                <div class="cip-form-row">
                    <div class="cip-form-group">
                        <label class="cip-label">
                            شماره گذرنامه
                            <span class="cip-optional">(اختیاری برای ایرانیان)</span>
                        </label>
                        <div class="cip-input-wrapper">
                            <input type="text"
                    ...
                    <div class="cip-form-group">
                        <label class="cip-label">
                            تاریخ انقضا پاسپورت
                            <span class="cip-optional">(اختیاری)</span>
                        </label>
                        <div class="cip-input-wrapper">
                            <input type="text"
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response && response.Result && response.Result.ProviderStatus === 'Success') {
                                ...
                                alert('رزرو با موفقیت ثبت شد. کد رزرو: ' + (response.Code || ''));
                            } else {
                                var errorMsg = 'خطا در ثبت رزرو. لطفا دوباره تلاش کنید.';
...
// تابع به‌روزرسانی باکس خلاصه سرویس‌های انتخاب شده
    function updateSelectedServicesSummary() {
        ...
        const grandTotal = mainServicePrice + ancillaryTotal;
    ...
    function generateSelectedServicesSummary(cipData) {
        ...
        <div class="cip-selected-services-summary">
            ...
            <div class="cip-summary-body">
                <!-- سرویس اصلی -->
                <div class="cip-summary-total-row main-service">
                    <span class="cip-summary-total-label">
                        <i class="fa-solid fa-star"></i>
                        ${mainServiceTitle}
                    </span>
                    <span class="cip-summary-total-value">
                        <span id="cip-main-service-price">${formatPrice(mainServicePrice)}</span>
                        <small>ریال</small>
                    </span>
                </div>
                ...
                <div class="cip-summary-total-row grand-total">
                    ...
                    <span class="cip-summary-total-value">
                        <span id="cip-grand-total-summary">${formatPrice(mainServicePrice)}</span>
                        <small>ریال</small>
                    </span>
                </div>
            </div>
            ...
            <input type="hidden" name="finalTotal" id="cip-final-total-input" value="${mainServicePrice}">
        </div>
        `;
    }
