...
jQuery(function (a) {
    a.datepicker.regional.fa = {
        calendar: JalaliDate,
        closeText: 'بستن',
        prevText: "<i class='fa-solid fa-chevron-right'></i>",
        nextText: "<i class='fa-solid fa-chevron-left'></i>",
...
function JalaliDate(i, h, f) {
    ...
    this.setDate = function (l) {
        console.group('setDate is called')
