   ...
   <div class="select position-unset inp-s-num adt box-of-count-nafar">
      <div
         ...
         <span class="text-count-nafar" v-if='form[strategy].passengers.count || form[strategy].duration'>
            {{ form[strategy].passengers.count }}  {{ useXmltag('Passenger')}},
            {{ form[strategy].duration }} {{ useXmltag('Daily')}}
         </span>
        <span class="text-count-nafar" v-else>
            {{ useXmltag('PassengersInformation')}}
         </span>
      ...
      <div
         ...
         <div
            ...
            <div class="col-md-12 mb-3 p-0">
               <h3 class="font-weight-bold m-0 font-19">{{ useXmltag('PassengersInformation')}}</h3>
            </div>
