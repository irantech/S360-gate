      ...
      <div class="box-search w-100">
         ...
         <div class="more-detail" :class="expand ? 'rotate' : ''">
            <div
               ...
               <div class="w-50">
                  <span class="title">{{ useXmltag("Airline") }}</span>
                  <span>{{ item.airline_name }}</span>
               </div>

               <div class="w-50">
                  <span class="title">{{ useXmltag("Numflight") }}</span>

                  <span>{{ item.flight_number }}</span>
               </div>
               <div class="w-50">
                  <span class="title"> {{ useXmltag("RunTime") }}</span>
               ...
               <div
                  ...
                  <a
                     target="_blank"
                     :href="`/gds/${getLang()}/pdf&target=parvazBookingLocal&id=${item.request_number}`"
