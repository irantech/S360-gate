                  ...
                  <div class="parent-counter-ticket-details d-none d-md-block">
                     <table>
                        ...
                        <tr>
                           ...
                           <th>قیمت پایه</th>
                           <th>مالیات</th>
                           <th v-if="this.$store.state.isCounter || this.$store.state.isSafar360">کمیسیون</th>
                        ...
                        <tr
                           ...
                           <td v-if="$store.state.isCounter || $store.state.isSafar360">
                              {{ formatPrice(item.CommisionPrice) }}
                           </td>
