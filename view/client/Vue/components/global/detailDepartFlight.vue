<template>
  <div class="parent-border-flight-information">
    <div class="parent-box-flight-information">
      ...
      <div class="parent-click-travel-data" v-for='( detail_flight , index ) in dept_detail_flight'
           :key='index'>
        <div class="parent-airplane-stop" v-if="detail_flight.is_transit && dataSearch.MultiWay !='multi_destination'">
