<template>
    <div class=" international-available-airlines pt-2">
      ...
      <div class="international-available-airlines-log-info pt-2">
        <div class="sandali-span2 iranL text-dark">{{ each_return_flight.airline_name}}</div>
      </div>

      <div class="international-available-airlines-log-info pt-2 site-main-text-color" v-if="each_return_flight.capacity > 0">
        <div class="sandali-span2 iranL sandali-span2-margin-right site-main-text-color">{{ each_return_flight.capacity}}{{useXmltag('Chair')}}</div>
      </div>
    </div>
</template>
