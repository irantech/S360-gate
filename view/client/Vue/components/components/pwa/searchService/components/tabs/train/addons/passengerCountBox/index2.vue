<template>
  <div class="select inp-s-num adt box-of-count-nafar">
    ...
    <div
      ...
      <div class="col-xs-12 cbox-count-nafar-ch textbox">
        <div
          class="btn-group w-100 d-flex flex-row-reverse btn-group-toggle"
          data-toggle="buttons">
          <label @click="changeSeatType('women_only')" class="btn btn-new">
            <input
              type="radio"
              name="options"
              id="option1"
          ...
          <label @click="changeSeatType('men_only')" class="btn btn-new">
            <input
              type="radio"
              name="options"
              id="option3"
          ...
          <label @click="changeSeatType('default')" class="btn btn-new active">
            <input
              type="radio"
              name="options"
              id="option2"
      ...
      <div class="col-xs-12 cbox-count-nafar-ch textbox">
        <div
          class="btn-group w-100 d-flex flex-row-reverse btn-group-toggle"
          data-toggle="buttons">
          <label @click="changeCoupeType(true)" class="btn btn-new">
            <input
              type="radio"
              name="options"
              id="optionType3"
          ...
          <label @click="changeCoupeType(false)" class="btn btn-new active">
            <input
              type="radio"
              name="options"
              id="optionType1"
      ...
      <div class="div_btn">
        <span @click="acceptData" class="btn btn-close site-bg-main-color"
          >تأیید</span
        >
      </div>
    </div>
