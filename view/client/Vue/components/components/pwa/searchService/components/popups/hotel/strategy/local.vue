...
export default {
  ...
  created() {
    if(this.getLang() != 'fa') {
      this.available_indexes.Cities.title_index = "CityNameEn"
      this.available_indexes.ReservationHotels.title_index = "HotelNameEn"
      this.available_indexes.ApiHotels.title_index = "HotelNameEn"
    }
