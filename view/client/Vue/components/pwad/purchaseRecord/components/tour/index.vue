    ...
    <div class="box-search w-100">
      ...
      <div class="more-detail" :class="expand ? 'rotate' : ''">
        <div
          ...
          <div class="w-50">
            <span class="title">زمان شروع تور</span>
          ...
          <div class="w-50">
            ...
            <span>{{ item.tour_night }} شب</span>
            <span>{{ item.tour_day }} روز</span>
          </div>
          ...
          <div v-if="item.status === 'BookedSuccessfully'" class="w-100 d-flex flex-wrap align-items-center">
            <a
              target="_blank"
              :href="`/gds/pdf&target=BookingTourLocal&id=${item.factor_number}`"
              class="col-5 offset-2 btn btn-success w-100 text-center"
              >دریافت بلیط</a
            >
            <a href="/gds/fa/UserTracking&type=tour" class="col-5 btn btn-primary w-100 text-center">استرداد</a>
          </div>
        </div>
