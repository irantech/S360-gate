  ...
  methods: {
    sortFlightByPrice() {
      ...
      if(this.type == 'international') {
        this.$store.commit('priceSortInternationalFlight', this.price_sort_filter);
      }else{
        this.$store.commit('priceSortFlight', this.price_sort_filter);
      }
