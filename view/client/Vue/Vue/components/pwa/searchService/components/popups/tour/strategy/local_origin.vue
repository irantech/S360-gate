...
export default {
  ...
  data() {
    return {
      allItem : {
        "city": { "title": "ههمه مبدا ها", "title_en": "all", "value": "all" }, "country": { "title": "", "value": "1" }
      },
      form: {
        origin: null,
      },
  ...
  methods: {
    async selectCity(city) {
      ...
      this.form[this.refillable.define] =  this.getLang() == 'fa' ?  city.city.title :  city.city.title_en
