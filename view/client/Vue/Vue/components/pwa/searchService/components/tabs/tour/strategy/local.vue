<template>
  <form class="d-contents row">
    <div class="col-lg-3 col-md-12 col-12 col_search search_col col_with_route">
      <div class="form-group origin_start">
        <div
          ...
          <span v-else>{{ useXmltag('Origin') }}</span>
        </div>
      ...
      <div class="form-group">
        <span class="destnition_start">
          <div
            ...
            <span v-else>{{ useXmltag('Destination') }}</span>
          </div>
   ...
   <div class="col-lg-3 col-md-12 col-12 col_search date_search">
      <div class="form-group">
