    ...
    <div class="row">
      <form method="post" class="d_contents" id="gds_bus" name="gds_bus">
        <div class='row'>
          ...
          <div
            class="col-lg-3 position-unset col-md-12 col-sm-12 col-12 col_search">
            <passenger-count-box
              :form="form"
          ...
          <div
            ...
            class="col-lg-3 col-md-12 col-12 col_search date_search">
            <div class="form-group">
              <template>
                <date_picker
                  popover
                  :placeholder="`${useXmltag('DateOfBirth')} ` + (key + 1)"
    ...
    searchInit() {
      ...
      if (duration_value === null) {
        ...
        this.$swal({
          ...
          timerProgressBar: true,
          timer: 4000,
          title: useXmltag('travelDurationChoose'),
        })
      }
