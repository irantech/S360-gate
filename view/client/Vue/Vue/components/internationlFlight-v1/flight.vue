<template>
  <div>
    <div class="card-flight-search">
        ...
        <div>
          <div class="parent-back-forth-search-flight">
            <div class="flight-number col-lg-1 col-md-2 col-sm-2 col-2 p-0">
              ...
              <span class="tooltips" :data-tooltip="useXmltag('Numflight')" data-tooltip-pos="up" data-tooltip-length="fit">{{ flight.flight_number }}</span>
            </div>
            <div class="flight-origin col-lg-3 col-md-2 col-sm-2 col-2 p-0">
              <h2  class="tooltips" :data-tooltip="useXmltag('Starttime')" data-tooltip-pos="up" data-tooltip-length="fit">{{ flight.departure_time }}</h2>
              <span class="tooltips" :data-tooltip="useXmltag('Origin')" data-tooltip-pos="down" data-tooltip-length="fit"> {{ flight.departure_name }}</span>
            </div>
            ...
            <div class="flight-destination col-lg-3 col-md-2 col-sm-2 col-2 p-0">
              <h2  class="tooltips" :data-tooltip="useXmltag('Returntime')" data-tooltip-pos="up" data-tooltip-length="fit"  v-if='flight.arrival_time'>{{ flight.arrival_time }}</h2>
              <span class="tooltips" :data-tooltip="useXmltag('Destination')" data-tooltip-pos="down" data-tooltip-length="fit"> {{ flight.arrival_name }}</span>
            </div>
            <div class="parent-time-trip" v-if='flight.duration_time'>
              ...
              <span class="tooltips" :data-tooltip="useXmltag('FlightDuration')" data-tooltip-pos="up" data-tooltip-length="fit">
            ...
            <div class="number-remaining-seats"  v-if="flight.capacity > 0">
              ...
              <span class="tooltips" :data-tooltip="useXmltag('Capacity')" data-tooltip-pos="down" data-tooltip-length="fit">
          ...
          <div class="parent-ticket-type-tail-brand">
            ...
            <div class="ticket-type">
              <div class="tooltips" :data-tooltip="useXmltag('Typeflight')" data-tooltip-pos="up" data-tooltip-length="fit">
                {{ flight.flight_type }}
              </div>
              <div class="tooltips" :data-tooltip="useXmltag('Classflight')" data-tooltip-pos="up" data-tooltip-length="fit">
                {{ flight.seat_class }}
              </div>
            </div>
          </div>
        </div>
        <div v-if="flight.return_routes !=''">
          <div class="parent-back-forth-search-flight">
            <div class="flight-number col-lg-1 col-md-2 col-sm-2 col-2 p-0">
              <img :src="`/gds/pic/airline/${flight.return_routes.airline}.png`" alt="img-airline" class="tooltips" :data-tooltip="useXmltag('AirlineName')" data-tooltip-pos="up" data-tooltip-length="fit">
              <span class="tooltips" :data-tooltip="useXmltag('Numflight')" data-tooltip-pos="up" data-tooltip-length="fit">{{ flight.return_routes.flight_number }}</span>
            </div>
            <div class="flight-origin col-lg-3 col-md-2 col-sm-2 col-2 p-0">
              <h2  class="tooltips" :data-tooltip="useXmltag('Starttime')" data-tooltip-pos="up" data-tooltip-length="fit">{{ flight.return_routes.departure_time }}</h2>
              <span class="tooltips" :data-tooltip="useXmltag('Origin')" data-tooltip-pos="down" data-tooltip-length="fit"> {{ flight.return_routes.departure_name }}</span>
            </div>
            <div class="flight-dotted-line col-lg-6 col-md-6 col-sm-6 col-6 p-0">
              <span class="circle-flight-origin"></span>
              <span class="border-flight-search">
            ...
            <div class="flight-destination col-lg-3 col-md-2 col-sm-2 col-2 p-0">
              <h2  class="tooltips" :data-tooltip="useXmltag('Returntime')" data-tooltip-pos="up" data-tooltip-length="fit"  v-if='flight.return_routes.arrival_time'>{{ flight.return_routes.arrival_time }}</h2>
              <span class="tooltips" :data-tooltip="useXmltag('Destination')" data-tooltip-pos="down" data-tooltip-length="fit"> {{ flight.return_routes.arrival_name }}</span>
            </div>
            <div class="parent-time-trip" v-if='flight.duration_time'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M138 0H298V48H242V97.4c43.4 5 82.8 23.3 113.8 50.9L385 119l17-17L435.9 136l-17 17-31 31c24 33.9 38.1 75.3 38.1 120c0 114.9-93.1 208-208 208S10 418.9 10 304C10 197.2 90.4 109.3 194 97.4V48H138V0zm80 464a160 160 0 1 0 0-320 160 160 0 1 0 0 320zm24-248V320v24H194V320 216 192h48v24z"/></svg>
              <span class="tooltips" :data-tooltip="useXmltag('FlightDuration')" data-tooltip-pos="up" data-tooltip-length="fit">
                {{ flight.return_routes.duration_time }}
            </span>
            </div>
            <div class="number-remaining-seats"  v-if="flight.return_routes.capacity > 0">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" ><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path class="fa-primary" d="M32 0C49.67 0 64 14.33 64 32V143.6C64 150.1 65.32 156.5 67.88 162.5L121.7 288H416C428.1 288 439.2 294.8 444.6 305.7C450 316.5 448.9 329.5 441.6 339.2L398.4 396.8C389.3 408.9 375.1 416 360 416H170.2C131.8 416 97.09 393.1 81.96 357.8L9.056 187.7C3.081 173.8 0 158.7 0 143.6V32C0 14.33 14.33 .0003 32 .0003V0z"/><path class="fa-secondary" d="M264 416V464H360C373.3 464 384 474.7 384 488C384 501.3 373.3 512 360 512H120C106.7 512 96 501.3 96 488C96 474.7 106.7 464 120 464H216V416H264zM80.53 192H320C337.7 192 352 206.3 352 224C352 241.7 337.7 256 320 256H107.1L80.53 192z"/></svg>
              <span class="tooltips" :data-tooltip="useXmltag('Capacity')" data-tooltip-pos="down" data-tooltip-length="fit">
                 {{ flight.return_routes.capacity }} {{useXmltag('Leftseat')}}
            </span>
            </div>
          </div>
          <div class="parent-ticket-type-tail-brand">
            ...
            <div class="ticket-type">
              <div class="tooltips" :data-tooltip="useXmltag('Typeflight')" data-tooltip-pos="up" data-tooltip-length="fit">
                {{ flight.return_routes.flight_type }}
              </div>
              <div class="tooltips" :data-tooltip="useXmltag('Classflight')" data-tooltip-pos="up" data-tooltip-length="fit">
                {{ flight.return_routes.seat_class }}
              </div>
            </div>
          </div>
        </div>
      ...
      <price-flight :flight='flight' @openFlightDetail='openDetail()' :show_detail='show_detail' :type="'international'"/>
      <flight-detail v-show='show_detail' :flight='flight' :type="'international'"/>
    </div>
