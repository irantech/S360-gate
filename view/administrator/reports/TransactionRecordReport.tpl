...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default ">
            <div class="panel-heading TitleSectionsDashboard" style="cursor: pointer;" data-toggle="collapse" data-target="#BoxTransaction">
            ...
            <div id="BoxTransaction" class="panel-collapse collapse in" style="overflow: auto;">
