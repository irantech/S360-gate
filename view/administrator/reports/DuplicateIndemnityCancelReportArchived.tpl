...
{assign var="reportsIndemnityCancel" value=$objReport->DuplicateIndemnityCancelReport('Archived')}
<br><br><br>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default ">
            <div class="panel-heading TitleSectionsDashboard" style="cursor: pointer;" data-toggle="collapse" data-target="#BoxEsterdadArchive">
                <h6 style="font-weight: 500; font-size: 17px; color: #3c3939; margin: 0;">
                   <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/admin">خانه</a> -
                    گزارش استرداد وجه تکراری آژانس های آرشیو شده
                    <div class="pull-right"><i class="ti-minus"></i></div>
                </h6>
            </div>
            <div id="BoxEsterdadArchive" class="panel-collapse collapse in" style="overflow: auto;">
