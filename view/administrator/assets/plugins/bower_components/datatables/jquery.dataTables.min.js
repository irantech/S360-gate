...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"اطلاعاتی برای نمایش موجود نمی باشد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ نتیجه",sInfoEmpty:"نمایش 0 تا 0 از 0 نتیجه",sInfoFiltered:"(جستجو از میان  _MAX_ نتیجه)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ نتیجه",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"متاسفانه نتیجه ایی مطابق جستجوی شما وجود ندارد "},oSearch:h.extend({},
