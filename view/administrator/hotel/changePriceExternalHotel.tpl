    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li>تنظیمات</li>
                <li class="active">تغییرات قیمت هتل خارجی</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <br>
                <form id="FormChangePriceHotel" method="post" action="{$smarty.const.rootAddress}hotel_ajax">
                    <input type="hidden" name="flag" value="insert_change_price_hotel">
                    <input type="hidden" name="type_application" id="type_application" value="externalApi">
                    ...
                    <div class="form-group col-sm-6 search-city-group">
                        <label for="city_code" class="control-label">نام شهر</label>
                        <input name="external-cities" id="search-external-cities" class="form-control"
                               autocomplete="off"
                               placeholder="جستجوی شهر خارجی">
                        <div class="search-cities-result shadow"></div>
                        <input name="city_code" id="city_code" type="hidden" class="d-none hidden">
                        {*                        <select name="city_code" id="city_code" class="select2 form-control">*}
                        {*                            <option value="">انتخاب کنید....</option>
                                                    <option value="all">همه شهرها</option>
                                                   {foreach $objPrice->getExternalCities()  as $city}
                                                        <option value="{$city.place_id}">{$city.city_name_en} - {$city.city_name_fa}</option>
                                                    {/foreach}*}
                        {*                        </select>*}
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select name="change_type" id="change_type" class="form-control ">
                            ...
                            <option value="increase" {if $smarty.post.abbreviation eq 'increase'}selected{/if}>افزایش
                            </option>
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped text-center">
                        ...
                        {foreach key=key item=item from=$objPrice->PriceChangeList('externalApi')}
                            {$number=$number+1}
                            <tr id="del-{$item.id}">
                                ...
                                <td>
                                    ...
                                    {else}
                                        {$objPrice->CityName($item.city_code,false)}
                                    {/if}
                                </td>
                                <td>
                                ...
                                <td>
                                    {if $item.is_del eq yes}
                                        <a href="#" onclick="return false"
                                           ...
                                           data-content="شما قبلا این بازه زمانی را حذف نموده اید">
                                    ...
                                    {else}
                                        <a id="DelChangePrice-{$item.id}" href="#"
                                           ...
                                           data-content="برای حذف بازه زمانی کلیک کنید"> <i
                                                    class="fcbtn btn btn-outline btn-danger btn-1c fa fa-trash "></i>
                                        </a>
                                        <a id="update" href="#"
                                           ...
                                           data-content="برای ویرایش تغییرات کلیک کنید"> <i
                                                    class="fcbtn btn btn-outline btn-primary btn-1c fa fa-edit "></i>
                                        </a>
                                    {/if}
                                </td>
                            </tr>
...
<div class="i-section">
    <div class="i-info">
        <span> ویدیو آموزشی بخش  تغییر قیمت هتل خارجی   </span>
    </div>
...
<style>
    ...
    .search-cities-result.loading:after {
