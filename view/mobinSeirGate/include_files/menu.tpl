...
{*                            <span class="brand-name">سانا سیر مبین</span>*}
{*                            <span class="brand-title">شرکت خدمات مسافرت هوایی</span>*}
                            <img alt="img-logo" src="project_files/images/logo-txt.png" />
                        </div>
                    </div>
                </div>
                ...
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu align-to-right">
                        ...
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/bus">اتوبوس</a>
                        </li>
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/train">قطار</a>
                        </li>
                        <li>
