...
{*                        </li>*}
                        <li class="" style="z-index: 9999999 !important;">
                    ...
                    <div class=" login-peigiri d-flex d-lg-none w-100 ms-0 mr-0" style="margin-right: 0 !important;">
                        <div class="act-buttons act-buttons-mobile w-100 m-0">
                            <div class="nav-search m-0">
                        ...
                        <div class="act-buttons peygiri w-100">
                ...
                <div class=" login-peigiri d-none d-md-flex">
                    <div class="act-buttons act-buttons-mobile">
                        <div class="nav-search">
                            <div class="top__user_menu">
                                ...
                                <div class="main-navigation__sub-menu2 arrow-up show-content-box-login-js"  style="margin-right: 40px;display: none">
