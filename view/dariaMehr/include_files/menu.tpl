...
<div class="nav-header">
                    <a alt="{$obj->Title_head()}" class="__logo_class__ nav-brand"
                       href="https://{$smarty.const.CLIENT_MAIN_DOMAIN}">
                        <img alt="venus" src="project_files/images/logo.png" alt="دوباره گردی" title="دوباره گردی" />
  <div class="logo-caption">
                            <h1>
                                <span class="top-span">دوباره گردی</span>
...
<li><a href="{$smarty.const.ROOT_ADDRESS}/page/visa">ویزای سفر</a></li>
    ...
    <li>
                            <a href="{$smarty.const.ROOT_ADDRESS}/page/dariamehr-charter">چارترهای دوباره گردی</a>
    </li>
<li>
    ...
    <li>
        ...
        <ul class="nav-dropdown nav-submenu">
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/mag">مجله دوباره گردی</a></li>
            <li><a href="{$smarty.const.ROOT_ADDRESS}/rules">قوانین و مقررات</a></li>
            <li><a href="{$smarty.const.ROOT_ADDRESS}/page/pay">درگاه پرداخت آﻧﻼﻳﻦ</a></li>
