...
<select aria-hidden="true" class="select2_in select2-hidden-accessible international-tour-origin-city-js" data-placeholder="مبدأ ( شهر )" id="tourOriginCityPortal" name="tourOriginCityPortal" onchange="getArrivalCitiesTour('international',this)" tabindex="-1">
