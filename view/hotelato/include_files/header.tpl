{load_presentation_object filename="hotelato" assign="obj_main_page" subName="customers"}
...
{*    <meta name="sabavision_advertiser_id" content="b5295fb8-bfe8-4aaf-be60-56183676faa9" />*}
{*    <meta http-equiv="Content-Security-Policy" content="script-src 'self' 'report-sample' 'unsafe-inline' 'unsafe-eval' https://plus.sabavision.com/; report-uri https://example.com/report-endpoint">*}
{*    {literal}*}
{*        <script src="https://plus.sabavision.com/dmp/dox/events.min.js" ></script>*}
{*        <script>*}
{*              __SabaEvents.initialize();*}
{*        </script>*}
{*    {/literal}*}

    {include file="`$smarty.const.FRONT_CURRENT_CLIENT`modules/rich/pageInfo/main.tpl" obj_main_page=$obj_main_page}

    {if $smarty.const.CLIENT_DOMAIN eq 'hotelatoir.com'}
        <meta name="google-site-verification" content="cIazidv2O16QammJ5PP-a65L8efVi-onIuAcgVD6SW8" />
...
{*        <link href="project_files/css/{$StyleSheetHeader}" rel="stylesheet"/>*}
    ...
    {literal}
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-16512580643"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'AW-16512580643');
        </script>
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-16742514048"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'AW-16742514048');
        </script>
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-X465FZC6V0"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-X465FZC6V0');
        </script>
    {/literal}
</head>
