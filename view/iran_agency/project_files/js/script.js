let myVideo = document.querySelector(".video-baner");
function videoCheng(e){
    myVideo.setAttribute("src", "video/"+e+".mp4");
}
...
$(document).ready(function () {
    ...
    $('body').on('click', '.myroom-hotel-item .close', function () {
        ...
        $('.myroom-hotel-item').each(function () {
            ...
            $(this).find('.myroom-hotel-item-title').html(' اتاق ' + numberText + '<span class="close"><i class="fal fa-trash-alt"></i></span>');
