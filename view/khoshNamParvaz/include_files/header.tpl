...
{load_presentation_object filename="khoshNamParvaz" assign="obj_main_page" subName="customers"}
...
{*        <script type="text/javascript" src="assets/datepicker-new/datepicker-declarations.js"></script>*}
    ...
    <script>
       !function (t, e, n) {
          ...
          s.id = "ua-script-BPUk2e34"; s.dataset.analyticsobject = n;
          s.async = 1; s.type = "text/javascript";
          s.src = "https://cdn.yektanet.com/rg_woebegone/scripts_v3/BPUk2e34/rg.complete.js?v=" + r, c.parentNode.insertBefore(s, c)
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-97BM2G88XM"></script>
    <script>
       window.dataLayer = window.dataLayer || [];
       function gtag(){dataLayer.push(arguments);}
       gtag('js', new Date());

       gtag('config', 'G-97BM2G88XM');
    </script>
    {/literal}
