...
{assign var="internal_tour_params" value=['type'=>'','limit'=> '8','dateNow' => dateNow, 'country' =>'internal', 'special' => '1']}
{assign var='hotel_internal' value=$obj_main_page->getHotelReservation($internal_tour_params)}
{if $hotel_internal}
...
{assign var="external_tour_params" value=['type'=>'','limit'=> '8','dateNow' => dateNow, 'country' =>'external', 'special' => '1']}
{assign var='hotel_external' value=$obj_main_page->getHotelReservation($external_tour_params)}
{if $hotel_external}
    {assign var='check_hotel' value=true}
{/if}
