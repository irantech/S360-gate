...
function gds_ticket_local_check() {
    ...
    if (origin == "" || destination == "" || dept_date == "" || adult == "")
    {
        ...
        var url = domain + "gds_test/local/1/" + ori_dep + "/" + dept_date + "/" + classf + "/" + num + "/";
...
function gds_ticket_portal_check() {
    ...
    if (origin == "" || destination == "" || dept_date == "" || adult == "") {
        ...
        var num = adult + "-" + child + "-" + infant;
        var domain = $("#gds_local").attr('action');
        var url = domain + "gds_test/local/2/" + ori_dep + "/" + date_final + "/" + classf + "/" + num + "/";
        window.location.href = url;
    }
}
...
function gds_insurance_check() {
    ...
    var url = domain + 'gds_test/resultInsurance/2/' + destination + "/" + duration + "/" + count + "/" + birthdates;
