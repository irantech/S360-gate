     ...
     <div class="d-flex flex-wrap">
      <div class="col-lg-4 col-md-6 col-sm-12 col-12 p-0">
       <div class="parent-item-footer parent-item-footer-responsive">
        ...
        <span>
         دفتر خدمات مسافرت هوایی و گردشگری
        </span>
          <h4>
           همسفران اورانوس
          </h4>
       ...
       <div class="parent-namad">
        ...
        <div class="namads">
         ...
         <a href="https://tehran.mcth.ir/">
          <img alt="namad-2" src="project_files/images/miras-Vezarat-Logo-12.jpg"/>
         </a>
{*         <a href="https://www.aira.ir/">*}
{*          <img alt="namad-2" src="project_files/images/lohoaira.png"/>*}
{*         </a>*}
{*         <a style="background: #b9b9b9;" href="https://farasa.cao.ir/sysworkflow/fa/modern/3810212626028ab03488017019616799/6464336316028ab04e3c618028352200.php">*}
{*          <img alt="namad-2" src="project_files/images/Logo_CAOIran.png"/>*}
{*         </a>*}
         <a href="" target="_blank" rel="nofollow">
          <img referrerpolicy='origin' id = 'rgvjjzpesizpjzpeoeukapfu' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=379785&p=xlaojyoepfvljyoemcsidshw", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=379785&p=qftiyndtbsiyyndtaqgwujyn' />
         </a>
         <a href="https://www.aira.ir/">
          <img alt="namad-2" src="project_files/images/certificate3.png"/>
         </a>
         <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=604619&Code=FHuNvg1j7ZPPBrSmN5pqoDENjoDwjNUG'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=604619&Code=FHuNvg1j7ZPPBrSmN5pqoDENjoDwjNUG' alt='' style='cursor:pointer' code='FHuNvg1j7ZPPBrSmN5pqoDENjoDwjNUG'></a>
        </div>
       </div>
      </div>
     </div>
