...
{assign var="tour_params" value=['type'=>'special','limit'=> '4','dateNow' => $dateNow, 'country' =>'','city' => null]}
...
<div class="calendar">
<span>تاریخ حرکت :  {assign var="year" value=substr($item['start_date'], 0, 4)}
                                {assign var="month" value=substr($item['start_date'], 4, 2)}
                                {assign var="day" value=substr($item['start_date'], 6)}
                                {$year}/{$month}/{$day}
                                </span>
</div>
<div class="__description_class__">{$item['description']}</div>
</div>
