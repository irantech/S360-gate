{assign var="countries" value=$obj_main_page->countryInsurance()}
 <div class="__box__ tab-pane  {if $smarty.const.PAGE_TITLE eq 'insurance' }active {/if} " id="Insurance">
...
<div class="col-lg-3 col-sm-6 col-12 col_search search_col nafarat-bime passenger-age-div-js">
<p class="label_input">
</p>
<div class="form-group">
