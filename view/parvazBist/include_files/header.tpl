...
{load_presentation_object filename="parvazBist" assign="obj_main_page" subName="customers"}
...
<meta content="ie=edge" http-equiv="X-UA-Compatible"/>
    ...
    {if $smarty.const.CLIENT_DOMAIN eq 'flyairtour.com'}
        {literal}
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-JMS8NJSDDV"></script>
            <script>
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());

              gtag('config', 'G-JMS8NJSDDV');
            </script>
        {/literal}
    {else}

        {literal}
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-5LLJ2S9Z3V"></script>
            <script>
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());

              gtag('config', 'G-5LLJ2S9Z3V');
            </script>
        {/literal}
    {/if}
...
{literal}
    <script type="text/javascript">
      !function(){var i="TaDUff",a=window,d=document;function g(){var g=d.createElement("script"),s="https://www.goftino.com/widget/"+i,l=localStorage.getItem("goftino_"+i);g.async=!0,g.src=l?s+"?o="+l:s;d.getElementsByTagName("head")[0].appendChild(g);}"complete"===d.readyState?g():a.attachEvent?a.attachEvent("onload",g):a.addEventListener("load",g,!1);}();
    </script>
{/literal}
