...
<div class="container">
<h2 class="title">مقاصد پر طرفدار</h2>
<div class="parent">
{if $blog[0]}
...
<h3 class="__heading_class__">{$blog[0]['heading']}</h3>
</div>
</a>
{/if}
{if $blog[1]}
...
<h3 class="__heading_class__">{$blog[1]['heading']}</h3>
</div>
</a>
{/if}
{if $blog[2]}
...
<h3 class="__heading_class__">{$blog[2]['heading']}</h3>
</div>
</a>
{/if}
{if $blog[3]}
...
<h3 class="__heading_class__">{$blog[3]['heading']}</h3>
</div>
</a>
{/if}
</div>
