...
'entertainment' =>'specialEntertainmentPic', 'Europcar' =>'specialEuropcarPic', 'Holidays' =>'specialHolidaysPic', 'Program' =>'specialProgramPic',
...
<script>
    ...
    if($(window).width() > 576){
        ...
        {literal}
       $('#Flight-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialInternalFlightPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialHotelPic}
        {literal}
       $('#Hotel-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialHotelPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialTrainPic}
        {literal}
       $('#Train-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialTrainPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialBusPic}
        {literal}
       $('.Bus-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialBusPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialTourPic}
        {literal}
       $('#Tour-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialTourPic}{literal}")')});
        {/literal}
        {/if}
       ...
       $('#Insurance-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialInsurancePic}{literal}")')});
        ...
        {if $specialVisaPic}
        {literal}
       $('#Visa-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialVisaPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialGashtPic}
        {literal}
       ...
       $('#Europcar-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialEuropcarPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialHolidaysPic}
        {literal}
       $('#holidays-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialHolidaysPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialProgramPic}
        {literal}
       $('#program-tab').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialProgramPic}{literal}")')});
        {/literal}
        {/if}
        {literal}
