         ...
         $(form).ajaxSubmit({
            ...
            success: function(response) {
               ...
               if (response.success === true) {
                  ...
                  setTimeout(function() {
                     // location.reload()
                     window.location = `${amadeusPath}itadmin/rajaTransactions/list`;
                  }, 2000)
               }
            },
...
function processExcel(trackingCode) {

   $.confirm({
      theme: 'supervan' ,// 'material', 'bootstrap'
      title: 'ثبت تراکنش های رجا',
      icon: 'fa fa-trash',
      content: 'آیا از ثبت تراکنش ها اطمینان دارید ؟',
      rtl: true,
      closeIcon: true,
      type: 'orange',
      buttons: {
               ...
               $.post(amadeusPath + 'user_ajax.php',
                  {
                     ...
                     flag: 'processExcelRaja'
                  },
                  function (data) {
                     var res = JSON.parse(data);
                     if (res.success) {
                        $.toast({
                           heading: 'تراکنش های رجا',
                           text: res.message,
                           position: 'top-right',
                           loaderBg: '#fff',
                           icon: 'success',
...
function deleteExcel(trackingCode) {

   $.confirm({
      theme: 'supervan' ,// 'material', 'bootstrap'
      title: 'حذف فایل تراکنش های رجا',
      icon: 'fa fa-trash',
      content: 'آیا از حذف فایل انتخابی اطمینان دارید ؟',
      rtl: true,
      closeIcon: true,
      type: 'orange',
      buttons: {
