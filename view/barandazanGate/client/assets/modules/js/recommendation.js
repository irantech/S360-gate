// function clickRecommenddation(e){
//   $(e).siblings(".migration-modal").css({"display": "flex"});
// }



$('.migration-owl').owlCarousel({
  nav:false,
  dots:true,
  rtl:true,
  loop:true,
...
$('.migration-owl2').owlCarousel({
  ...
  $(".parent-multiplication").click(function (){
    $(".migration-modal").css("display","none");
  });
//   $(".footer-card").click(function (){
//   $(".migration-modal").css("display","flex");
// });
  $(".migration-modal").click(function (e) {
  if (e.target === this) {
  $(".migration-modal").css("display","none")
}
});
