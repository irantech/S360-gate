$(document).ready(function () {
    ...
    $('#number_of_passengers').on('change', function (e) {
        ...
        var i = 1;
        while (i < itemInsu) {
            HtmlCode += "<div class='p-1 col-lg-2 col-md-4 col-sm-6 col-12 col_search nafarat-bime'>" +
    ...
    $(document).ready(function () {
        ...
        $('.main-navigation__button2').click(function (e) {
            $('.main-navigation__sub-menu2').toggleClass("toggleClass-login");
            e.stopPropagation();
            $('.button-chevron-2').toggleClass('rotate');
        });
        $("html,body").click(function () {
            $('.main-navigation__sub-menu2').removeClass("toggleClass-login");
        });
    ...
    $('body').on('click', '.myroom-hotel-item .close', function () {
        ...
        $('.myroom-hotel-item').each(function () {
            ...
            $(this).find('.myroom-hotel-item-title').html('<span class="close"><i class="fa fa-trash-alt"></i></span> ' +  ' اتاق ' + numberText);
    ...
    $('.mypackege-rooms').on('click', '.myroom-package-item .close', function () {
        ...
        $('.myroom-package-item').each(function () {
            ...
            $(this).find('.myroom-package-item-title').html('<span class="close"><i class="fa fa-trash-alt"></i></span> ' +  ' اتاق ' + numberText);
