<ul class="nav nav-tabs" id="myTab" role="tablist">
    {foreach $info_access_client_to_service as $key=>$client}
        {if $client['Title'] eq 'تور'}
            <li class="nav-item">
                <a class="nav-link active " id="{$client['MainService']}-tab" data-toggle="tab" href="#{$client['MainService']}" role="tab"
    ...
    {/foreach}
    <li  class="nav-item">
        <a  class="nav-link  "  id="flight-tab"  href="http://mpcharter.com/" >
            <span>
                <i class="icon-tab icon-airplane">&#xe800;</i>
                <h4>هواپیما</h4>
            </span>
        </a>
    </li >
    <li  class="nav-item">
        <a  class="nav-link"  id="reservation"  href="{$smarty.const.ROOT_ADDRESS}/page/tourReserve"  >
            <span>
                <i class="icon-tab icon-list">
