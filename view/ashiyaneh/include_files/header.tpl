...
<head>
    ...
    {if $smarty.const.GDS_SWITCH eq 'mainPage' || $smarty.const.GDS_SWITCH eq 'page'}
        ...
        <link rel="stylesheet" href="assets/all-css/owl.carousel.min.css"><link rel="stylesheet" href="project_files/css/owl.carousel.min.css"><link rel="stylesheet" href="project_files/css/tab.css">
