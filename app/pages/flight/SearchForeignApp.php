    ...
    <div class="page-content">
        <div class="nav-search site-bg-main-color-before">
            <div class="nav-search-inner">
                <div class="back-link">
                    <a href="<?php echo ROOT_ADDROOT_ADDRESS_WITHOUT_LANGRESS . '/app/'?>" class="link back external">
                        <span></span>
                    </a>
                </div>
                <div class="title">جست و جو پرواز خارجی</div>
            </div>
        </div>
        <div class="search-bar-app">
            <input type="hidden" value="FlightZone" id="TypeZoneFlight" name="TypeZoneFlight">
            <input type="hidden" value="Foreign" id="TypeSearch" name="TypeSearch">
            <div class="list list-search">
                <ul>
                        ...
                        <div class="item-content">
                            <div class="item-inner">
                                ...
                                <label class="toggle raft-o-bargasht toggle-init color-green">
                                    <input type="checkbox" name="DeptReturnButtonForeign" id="DeptReturnButtonForiegn">
                    ...
                    <li>
                        ...
                        <a class="item-link item-content" href="#" id="autocomplete-standalone-Origin-foreign">
                    ...
                    <li>
                        ...
                        <a class="item-link item-content" href="#" id="autocomplete-standalone-Destination-foreign">
                        ...
                        <div class="item-content item-input raft-date">
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-input-wrap DepartureDateForeign">
                                    <input type="text" readonly="readonly" placeholder="--/--/----" id="demo-calendar-default"/>
                                </div>
                            </div>
                        </div>
                        <input class="hidden-bargasht-input" type="text" value="0" type="hidden">
                        <div class="item-content item-input bargasht-date">
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-input-wrap ReturnDateForeign">
                                    <input  type="text" readonly="readonly" placeholder="--/--/----" id="demo-calendar-default2"/>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="stepper-nafarat">
                        <div class="item-inner">
                            ...
                            <div class="item-after">
                                <div class="stepper stepper-init stepper-small stepper-raised" data-min="1" data-value-el="#apples-count">
                          ...
                          <g>
                              ...
                              <path d="M38.325,25.607H17.379c-1.239,0-2.244,1.005-2.244,2.244c0,1.239,1.005,2.245,2.244,2.245h20.946
								  c1.239,0,2.244-1.006,2.244-2.245C40.569,26.612,39.564,25.607,38.325,25.607z"/>
                                    ...
                                    <div class="show-number AdultNumberForeign"><span id="apples-count"></span></div>
                          ...
                          <g>
                              ...
                              <path d="M38.325,25.607H17.379c-1.239,0-2.244,1.005-2.244,2.244c0,1.239,1.005,2.245,2.244,2.245h20.946
								  c1.239,0,2.244-1.006,2.244-2.245C40.569,26.612,39.564,25.607,38.325,25.607z"/>
                                    ...
                                    <div class="show-number ChildNumberForeign"><span id="oranges-count"></span></div>
                                    <div class="stepper-button-plus">
                                        <div class="stepper-svg">
                                            <svg class="site-bg-svg-color" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                 viewBox="0 0 304.223 304.223" style="enable-background:new 0 0 304.223 304.223;" xml:space="preserve">
                          ...
                          <g>
                              ...
                              <path d="M38.325,25.607H17.379c-1.239,0-2.244,1.005-2.244,2.244c0,1.239,1.005,2.245,2.244,2.245h20.946
								  c1.239,0,2.244-1.006,2.244-2.245C40.569,26.612,39.564,25.607,38.325,25.607z"/>
                                    ...
                                    <div class="show-number InfantNumberForeign"><span id="oranges-count2"></span></div>
                                    <div class="stepper-button-plus">
                                        <div class="stepper-svg">
                                            <svg class="site-bg-svg-color" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                 viewBox="0 0 304.223 304.223" style="enable-background:new 0 0 304.223 304.223;" xml:space="preserve">
                    ...
                    <li class="search-btn">
                        ...
                        <a href="#" class="button button-fill site-bg-main-color SearchTicket">
