...
class insurancePriceChanges {
    ...
    public function getAll() {
        ...
        $query = "SELECT * FROM insurance_price_changes_tb";
    ...
    public function update($input) {
        ...
        $Model = Load::library('Model');
        $Model->setTable('insurance_price_changes_tb');
    ...
    public function getByCounter($CounterType) {
        ...
        $Model = Load::library('Model');
        $query = "SELECT * FROM insurance_price_changes_tb WHERE counter_id = '{$CounterType}'";
