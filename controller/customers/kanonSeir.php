    ...
    class kanonSeir extends mainPage {
        ...
        public $icons_json = '{"Tour_internal": {"name": "تور داخلی"}, "Tour_external": {"name": "تور خارجی"}, "hotel": {"name": "هتل"}, "flight": {"name": "بلیط هواپیما"}, "javascript:": {"name": "رویدادهای فرهنگی"}}';
