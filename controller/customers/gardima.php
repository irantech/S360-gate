...
class gardima extends mainPage {
    ...
    public $icons_json = '{"Flight": {"name": "پرواز" , "icon": "<i class=\"fal fa-plane-alt\"></i>"},
                                "Hotel": {"name": "هتل", "icon": "<i class=\"fal fa-hotel\"></i>"},
                                "Tour": {"name": "تور", "icon": "<i class=\"fal fa-suitcase-rolling\"></i>"},
                                "Insurance": {"name": "بیمه", "icon": "<i class=\"fal fa-umbrella-beach\"></i>"},
                                "Bus": {"name": "اتوبوس", "icon": "<i class=\"fal fa-bus\"></i>"},
                                "Visa": {"name": "ویزا", "icon": "<i class=\"fal fa-passport\"></i>"}
