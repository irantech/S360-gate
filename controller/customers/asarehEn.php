...
class asarehEn extends mainPage {
    ...
    public function hotel_types_names($id) {
        $hotel_types = array(
            ...
            '6' => 'Rural Lodge',
            '7' => 'Forest Hotel',
            '8' => 'Cultural and Recreational Complex',
            '9' => 'Pension',
            '10' => 'Motel',
            '12' => 'Villa',
            '13' => 'Caravanserai',
            '14' => 'Accommodation Complex',
            '15' => 'Local House',
            '16' => 'Villa-Hotel',
            '100' => 'Hostel',
            '101' => 'Boutique Hotel',
            '110' => 'Traditional Rooftop Suites in Khalkhal',
        );
    ...
    public function nameSearchBoxButton($service_name) {
        switch ($service_name) {
            case 'Flight':
