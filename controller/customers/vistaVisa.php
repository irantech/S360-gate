    ...
    class vistaVisa extends mainPage {
    ...
    "Flight_internal": {
        ...
        "name": "رزرو بلیط هواپیما داخلی",
        "name_tab": "پرواز داخلی",
        "caption": " برای خرید آنلاین بلیط هواپیما در ویستا ویزا کافیست مبدا، مقصد و تاریخ پرواز خود را انتخاب کنید."
    },
    "Flight_external": {
        ...
        "name": "رزرو بلیط هواپیما خارجی ",
        "name_tab": "پرواز خارجی ",
        "caption": " برای خرید آنلاین بلیط هواپیما در ویستا ویزا کافیست مبدا، مقصد و تاریخ پرواز خود را انتخاب کنید."
    },
    "Hotel": {
        ...
        "name": "رزرو هتل‌های داخلی و خارجی با بهترین قیمت",
        "name_tab": "هتل",
        "caption": "بهترین هتل‌ها را در داخل و خارج از کشور با تخفیف‌های ویژه رزرو کنید و از سفری راحت و بی‌دغدغه لذت ببرید. "
    },
    "Tour": {
        ...
        "name": "تورهای ویژه داخلی و خارجی با خدمات استثنایی",
        "name_tab": "تور",
         "caption": "با ویستا ویزا، سفرهای داخلی و خارجی را به تجربه‌هایی فراموش‌نشدنی تبدیل کنید "
    },
        "Visa": {
        "icon": "<i><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 448 512\"><path d=\"M224 80c-70.75 0-128 57.25-128 128s57.25 128 128 128s128-57.25 128-128S294.8 80 224 80zM129.6 224h39.13c1.5 27 6.5 51.38 14.12 70.38C155.3 281.1 134.9 255.3 129.6 224zM168.8 192H129.6c5.25-31.25 25.62-57.13 53.25-70.38C175.3 140.6 170.3 165 168.8 192zM224 302.8C216.3 295.3 203.3 268.3 200.6 224h46.75C244.8 268.3 231.8 295.3 224 302.8zM200.5 192C203.3 147.8 216.3 120.8 224 113.3C231.8 120.8 244.8 147.8 247.4 192H200.5zM265.1 294.4C272.8 275.4 277.8 251 279.3 224h39.13C313.1 255.3 292.8 281.1 265.1 294.4zM279.3 192c-1.5-27-6.5-51.38-14.12-70.38c27.62 13.25 48 39.13 53.25 70.38H279.3zM448 368v-320C448 21.49 426.5 0 400 0h-320C35.82 0 0 35.82 0 80V448c0 35.35 28.65 64 64 64h368c8.844 0 16-7.156 16-16S440.8 480 432 480H416v-66.95C434.6 406.4 448 388.8 448 368zM384 480H64c-17.64 0-32-14.36-32-32s14.36-32 32-32h320V480zM400 384H64c-11.71 0-22.55 3.389-32 8.9V80C32 53.49 53.49 32 80 32h320C408.8 32 416 39.16 416 48v320C416 376.8 408.8 384 400 384z\"/></svg></i>",
        "name": "اخذ ویزای سریع و مطمئن برای مقاصد بین‌المللی",
        "name_tab": "ویزا",
        "caption": "فرآیند اخذ ویزا را به سادگی و با اطمینان کامل انجام دهید و به راحتی برای سفرهای بین‌المللی خود آماده شوید."
    },
    "Insurance": {
        ...
        "name": "بیمه مسافرتی مطمئن برای سفرهای داخلی و خارجی",
        "name_tab": "بیمه",
        "caption": " بهترین بیمه مسافرتی با پوشش‌های جامع و قیمت‌های رقابتی را تهیه کنید و با خیال راحت به سفرهای داخلی و خارجی بروید. "
    }
}';
        ...
        public function nameTabsSearchBox($service_name) {
            $result_array = $this->getItemsBykeyFromJsonServicesArray($this->icons_json, 'name_tab');
        ...
        public function captionBoxSearchBox($service_name) {
            $result_array = $this->getItemsBykeyFromJsonServicesArray($this->icons_json, 'caption');
            return $result_array[$service_name];
        }
