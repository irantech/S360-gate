    ...
    class reshnoParvaz extends mainPage {
        ...
        public $icons_json = '{"Tour": {"icon": "<i class=\"fa-duotone fa-suitcase-rolling\"></i>", "name": "تور"}, "Visa": {"icon": "<i class=\"fa-duotone fa-earth-americas\"></i>", "name": "ویزا"}}';
