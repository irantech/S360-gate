...
class atiyeGasht extends mainPage {
    ...
    public $icons_json = '{"Train": {"icon": "<i class=\"fa-duotone fa-train-subway\"></i>", "name": "قطار"},
                              "Tour": {"icon": "<i class=\"fa-duotone fa-suitcase-rolling\"></i>", "name": "تور"}}';
    public function getInfoAuthClient() {
        if(functions::isTestServer()) {
            $access_list = ['Train' , 'Tour'] ;
