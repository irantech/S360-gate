...
//        @ini_set('display_errors', 'on');
    ...
    class ozhanGashtGds extends mainPage {
        ...
        public $icons_json = '{"Flight": {"icon": "<i class=\"fa-solid fa-plane-departure\"></i>", "name": "هواپیما"},
             "Hotel": {"icon": "<i class=\"fa-light fa-hotel\"></i>", "name": "هتل"},
             "Tour": {"icon": "<i class=\"fa-light fa-person-walking-luggage\"></i>", "name": "تور"},
             "Bus": {"icon": "<i class=\"fa-light fa-bus\"></i>", "name": "اتوبوس"},
             "Visa": {"icon": "<i class=\"fa-light fa-passport\"></i>", "name": "ویزا"},
             "Entertainment": {"icon": "<i class=\"fa-light fa-water-ladder\"></i>", "name": "تفریحات"},
             "Insurance": {"icon": "<i class=\"fa-light fa-umbrella\"></i>", "name": "بیمه"}}';
