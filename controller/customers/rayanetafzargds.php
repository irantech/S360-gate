    ...
    class rayanetafzargds extends mainPage {
        ...
        public $icons_json = '{"Flight": {"icon": "<i class=\"icon-tab icon-airplane\">&#xe800;</i>", "name": "هواپیما"},
             "Hotel": {"icon": "<i class=\"icon-tab icon-bed\">&#xe808;</i>", "name": "هتل"},
             "Bus": {"icon": "<i class=\"icon-tab icon-bus\">&#xe80c;</i>", "name": "اتوبوس"},
             "Insurance": {"icon": "<i class=\"icon-tab icon-travel-insurance\">&#xe80d;</i>", "name": "بیمه"}}';
