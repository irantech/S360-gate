...
//    }
    ...
    class manshoorTravel extends mainPage {
        ...
        public $icons_json = '{"Flight": {"class" : "item-plan mask" ,"icon": "<i class=\"fa-solid fa-plane-up\"></i>" },
                               "Hotel": {"class" : "item-hotel mask" , "icon": "<i class=\"fa-solid fa-hotel\"></i>"},
                               "Insurance": { "class" : "item-insurance mask" ,"icon": "<i class=\"fa-sharp fa-solid fa-umbrella\"></i>" },
                               "Tour": { "class" : "item-insurance mask" ,"icon": "<i class=\"fa-solid fa-suitcase-rolling\"></i>" }}';
...
//            var_dump($this->icons_json);
        ...
        public function classChangeTabsSearchBox($service_name) {
            $result_array = $this->getItemsBykeyFromJsonServicesArray($this->icons_json, 'class');
            return $result_array[$service_name];
        }
