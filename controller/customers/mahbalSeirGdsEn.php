...
<?php
    ...
    class mahbalSeirGdsEn extends mainPage {
        ...
        public $icons_json = '{"Flight": {"icon": "<i class=\"icon-tab icon-airplane\"></i>", "name": "Airplane"}, "Hotel": {"icon": "<i class=\"icon-tab icon-bed\"></i>", "name": "Hotel"}}';
