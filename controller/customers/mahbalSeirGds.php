    ...
    class mahbalSeirGds extends mainPage {
        ...
        public $icons_json = '{"Flight": {"icon": "<i class=\"fa-light fa-plane-up\"></i>", "name": "هواپیما"}, "Hotel": {"icon": "<i class=\"fa-light fa-hotel\"></i>", "name": "هتل"}, "Tour": {"icon": "<i class=\"fa-light fa-suitcase-rolling\"></i>", "name": "تور"}, "Visa": {"icon": "<i class=\"fa-light fa-passport\"></i>", "name": "ویزا"}, "Insurance": {"icon": "<i class=\"fa-light fa-umbrella\"></i>", "name": "بیمه"}}';
