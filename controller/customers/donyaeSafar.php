    ...
    class donyaeSafar extends mainPage {
        ...
        public $icons_json = '{"Flight": {"icon": "fa-light fa-plane", "name": "بلیط"},
                              "Hotel": {"icon": "fa-light fa-bed-front", "name": "هتل"},
                              "Tour": {"icon": "fa-light fa-backpack", "name": "تور"},
                              "Insurance": {"icon": "fa-light fa-umbrella", "name": "بیمه"},
                              "Visa": {"icon": "fa-light fa-book-atlas", "name": "ویزا"}}';
