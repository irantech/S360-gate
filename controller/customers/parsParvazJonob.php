    ...
    class parsParvazJonob extends mainPage {
...
//        public $icons_json = '{"Flight": {"name": "هواپیما"}, "Hotel": {"name": "هتل"}, "Bus": {"name": "اتوبوس"}, "Tour": {"name": "تور"}, "Visa": {"name": "ویزا"}}';
