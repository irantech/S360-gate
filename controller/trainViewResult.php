 ...
 */
class trainViewResult extends trainResult
{
...
//        }
  ...
  /*      if ((isset($_SERVER["HTTP_HOST"]) && strpos($_SERVER["HTTP_HOST"], 'indobare.com') !== false)) {
        ...
        ob_start();
        ?>
        <form action="#" method="post" id="TrainFormHidden" name="TrainFormHidden">
        ...
        require_once 'newTrain/sortByTimeAndPrice.php';
                                    ...
                                    <div class="international-available-item">
                                        <div class="international-available-info">
                                            <div class="international-available-item-right-Cell ">
                                                <?php
                                                $specific = true ;
                                                include 'newTrain/logoTrain.php';
                                                include 'newTrain/infoTrain.php';
                                                ?>
                                            </div>
                                            <?php
                                            include 'newTrain/infoPriceTrain.php';
                                            include 'newTrain/infoDetailTrain.php';
                                            ?>
