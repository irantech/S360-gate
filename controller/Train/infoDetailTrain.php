    ...
    <div>
        <div class=" international-available-panel-min">
            ...
            <div id="tab-1-<?php echo $key ?>"
                ...
                <div class="international-available-airlines-detail-tittle">
                    ...
                    <div class="international-available-airlines-detail   site-border-right-main-color">
                        ...
                        <img src="<?php echo ROOT_ADDRESS_WITHOUT_LANG.'/pic/load.gif' ?>" class="loaderSearchTrain"
                             id="loaderSearch<?php echo $key ?>"
                             name="loaderSearch">

                        <div class="airlines-detail-box " style=" width: 100%" id="extera_service_<?php echo $key ?>">
            ...
            <div id="tab-2-<?php echo $key ?>" class="tab-content">
                ...
                <ul>
                    <li>1. حضور در ایستگاه یک ساعت قبل از حرکت الزامی است. ده دقیقه قبل از حرکت قطار از ورود شما به قطار
                        جاوگیری خواهد شد
                    </li>
                    <li>2. همراه داشتن بلیت یا کارت قطار و کارت شناسایی معتبر تا انتهای سفر الزامی است.درصورت غیرهمنام
                        بودن بلیت،از سوار شدن مسافر به قطار جلوگیری می گردد
                    </li>
                    <li>3. خانواده معظم شهدا و جانبازان عزیز(با درصد جانبازی بیش از 25)در صورت ارائه کارت بنیاد شهید و
                        امور ایثارگران و همراه جانباز در صورت داشتن مجوز همراهی و همچنین مسافران 2 الی 12 سال،مشول 50%
                    ...
                    <li>4. طبق مقررات،تا یک ساعت پس از صدور بلیت به شرط عدم حرکت قطار و مراجعه به آژانس صادرکننده،بلیت
                        با پرداخت 100% بهای آن قابل استرداد می باشد.درصورت استرداد تا ساعت 12:00 روز قبل از حرکت ،90% کل
                        بهای بلیت و تا 3 ساعت مانده به حرکت قطار،70% کل بهای بلیت و تا لحظه حرکت قطار،50% کل بهای بلیت
                    ...
                    <li>5. سامانه اطلاع رسانی و پاسخگویی به شکایات معاونت مسافری راه آهن ج.ا.ا 5149- 021 برای کلیه
                        قطارهای مسافری و همچنین سامانه 300004609 و نیز 12-44281610- 021 جهت شرکت جوپار آماده پاسخگویی می
                        باشد.
                    </li>
                    <li>6. استعمال دخانیات در قطار ممنوع می باشد.جهت اطلاع از شرایط سفر با قطار و سایر قوانین و مقررات
                        به سایت www.rai.ir مراجعه نمایید
                    </li>
                    <li style="color:red;">7.بلیطهای چارتری غیرقابل استرداد بوده و هیچ هزینه ای بابت استرداد این بلیطها عودت نخواهد شد
                    </li>
                </ul>
                </p>
            </div>
...
//            }
        ...
        <div class="my-more-info-train "
             onclick="more_info_train($(this),<?php echo $key ?>)"
    ...
    <input type="hidden" name="SCP<?php echo $key ?>" id="SCP<?php echo $key ?>" value="<?php echo $ticketTrain['CircularPeriod']?>">
    <input type="hidden" name="TrainNO<?php echo $key ?>" id="TrainNO<?php echo $key ?>" value="<?php echo $ticketTrain['TrainNumber']?>">
    <input type="hidden" name="Scps<?php echo $key ?>" id="Scps<?php echo $key ?>" value="<?php echo $ticketTrain['CircularNumberSerial']?>">
    <input type="hidden" name="WagonTypeCode<?php echo $key ?>" id="WagonTypeCode<?php echo $key ?>" value="<?php echo $ticketTrain['WagonType']?>">
    <input type="hidden" name="MovDateTrain<?php echo $key ?>" id="MovDateTrain<?php echo $key ?>" value="<?php echo $ticketTrain['MoveDate']?>">
    <input type="hidden" name="MovTimeTrain<?php echo $key ?>" id="MovTimeTrain<?php echo $key ?>" value="<?php echo $ticketTrain['ExitTime']?>">
