 ...
 * @property dateTimeSetting $dateTimeSetting
 */
error_reporting( 0);
class dateTimeSetting {
	public static function jdate($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa') {
		...
		$j_m = (int)$j_m; //example 01 -> 1
		$j_d = (int)$j_d; //example 01 -> 1
	...
	public static function jmktime($h = '', $m = '', $s = '', $jm = '', $jd = '', $jy = '', $timezone = 'Asia/Tehran') {
...
//        if($gd < 10){ $gd = '0' . $gd; }
	...
	public static function jtoday($mod = '-') {
		$format = 'Y' . $mod . 'm' . $mod . 'd';
		if (SOFTWARE_LANG == 'fa') {
			return self::jdate($format, time(), '', '', 'en');
		} else {
    ...
    public static function tomorrow(){
        $today = self::jtoday();
        return self::jdate( 'Y-m-d', strtotime( 'tomorrow' ), '', '', 'en' );
    }
    public static function yesterday()
    {
        $today = self::jtoday();
        return self::jdate( 'Y-m-d', strtotime( 'yesterday' ), '', '', 'en' );
    }
    public static function daysAfterToday($day){
        return self::jdate( 'Y-m-d', strtotime( '+'.$day .'day' ), '', '', 'en' );
    }
