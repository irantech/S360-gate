<div class="sorting2" id="sortFlightInternal">
    ...
    <div class="sorting-inner date-change iranL prev">
        <a class="prev-date" <?php if ($this->indate($dept_date) && $MultiWay == 'OneWay') {
            echo 'href="' . ROOT_ADDRESS_WITHOUT_LANG . '/' . $lang . '/local/1/' . $origin . '-' . $destination . '/' . $this->DatePrev($dept_date) . '/Y/' . $adult . '-' . $child . '-' . $infant . '"';
        } ?>>
            <i class="zmdi zmdi-chevron-right iconDay "></i>
            <span><?php echo $dataArrayFlight['Previousday'] ?></span>

        </a>
    </div>
    

    <div class="sorting-inner price sorting-active-color-main" id="priceSortSelect">
        <span class="svg">
        ...
        <span class="text-price-sort iranL"><?php echo $dataArrayFlight['Baseprice'] ?></span>
        <input type="hidden" value="desc" name="currentPriceSort" id="currentPriceSort">
    </div>
    <div class="sorting-inner time" id="timeSortSelect">
        ...
        <span class="text-price-sort iranL"><?php echo $dataArrayFlight['BaseStartTime'] ?></span>

        <input type="hidden" value="desc" name="currentTimeSort" id="currentTimeSort">
    </div>

    <div class="sorting-inner date-change iranL next">
        <a class="next-date" <?php if ($MultiWay == 'OneWay') {
            echo 'href="' . ROOT_ADDRESS_WITHOUT_LANG . '/' . $lang . '/local/1/' . $origin . '-' . $destination . '/' . $this->DateNext($dept_date) . '/Y/' . $adult . '-' . $child . '-' . $infant . '"';
        } ?>>
            <span><?php echo $dataArrayFlight['Nextday'] ?></span>
    ...
    <div class="dateprice filter_search_mobile ">
        <div class=" site-border-main-color" id="lowerSortSelect" onclick="getUserAccount()">

        <span class="dataprice-icon">
        <svg class="site-bg-svg-color" height="512pt" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg"><path d="m452 40h-24v-40h-40v40h-264v-40h-40v40h-24c-33.085938 0-60 26.914062-60 60v352c0 33.085938 26.914062 60 60 60h392c33.085938 0 60-26.914062 60-60v-352c0-33.085938-26.914062-60-60-60zm-392 40h24v40h40v-40h264v40h40v-40h24c11.027344 0 20 8.972656 20 20v48h-432v-48c0-11.027344 8.972656-20 20-20zm392 392h-392c-11.027344 0-20-8.972656-20-20v-264h432v264c0 11.027344-8.972656 20-20 20zm-136-42h120v-120h-120zm40-80h40v40h-40zm0 0"/></svg>
        </span>

            <span class="text-dateprice site-main-text-color"> <?php echo functions::Xmlinformation("CalenderPrice"); ?></span>
    ...
    <div class="filter_search_mobile_res">
        ...
        <svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  version="1.1"  x="0" y="0" viewBox="0 0 512 512"  xml:space="preserve" class="site-bg-svg-color"><g>
                <g xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="m432.733 369.533h-164.194c-6.281-18.655-23.926-32.133-44.672-32.133s-38.391 13.478-44.672 32.133h-99.928c-8.284 0-15 6.716-15 15s6.716 15 15 15h99.928c6.281 18.655 23.926 32.133 44.672 32.133s38.391-13.478 44.672-32.133h164.195c8.284 0 15-6.716 15-15s-6.716-15-15.001-15zm-208.866 32.134c-9.447 0-17.133-7.686-17.133-17.133s7.686-17.133 17.133-17.133 17.133 7.685 17.133 17.132-7.686 17.134-17.133 17.134z" fill="#009aff" data-original="#000000" style="" class=""/>
                </g>
            </g>
            </svg>

        <span class="site-main-text-color"> <?php echo functions::Xmlinformation("Filter"); ?></span>
    </div>
